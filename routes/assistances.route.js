...
router.get("/:user_id/:event_id", privateRoute, async (req, res, next) => {  //Consultar todos los posts
...
router.post("/:user_id/:event_id", privateRoute, async (req, res, next) => {  //Consultar todos los posts
    res.json(await pdao.postAssistances(req.params.user_id, req.params.event_id));
})

router.put("/:user_id/:event_id", privateRoute, async (req, res, next) => {  //Consultar todos los posts
...
router.delete("/:user_id/:event_id", privateRoute, async (req, res, next) => {  //Consultar todos los posts
